...
const OurServicesHeader: NextPage = () => {
  return (
    <div className="flex max-w-full flex-row items-center justify-center gap-[1.5rem] self-stretch text-left font-text-sm-semibold text-[1rem] text-content-light-main">
